...
%  table of the digraph. An edge index of 0 indicates an edge that is not in
%  the digraph. s and t must be valid node IDs---that is, they must either
...
%  If the edges are not in the graph, then idx is 0.
%
