function t = bfsearch(G, s, varargin)
...
%
%   T = BFSEARCH(G,s,EVENTS) customizes the output by flagging one or more
%   search events.
%   EVENTS can be:
%
...
%
%   Example:
%       % Create and plot a digraph. Perform a breadth-first search 
