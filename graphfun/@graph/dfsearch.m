function t = dfsearch(G, s, varargin)
...
%
%   T = DFSEARCH(G,s,EVENTS) customizes the output by flagging one or more
%   search events.
%   EVENTS can be:
%
...
%
%   Example:
%       % Create and plot a graph. Perform a depth-first search 
